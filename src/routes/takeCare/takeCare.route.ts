...
export class TakeCareRoute extends BaseRoute {
    ...
    private test = async (req, response, next) => {
        ...
        response.status(200).json({
            ...
            'start-of-date': DateUtil.startOf(new Date(), 'days').toLocaleDateString() + ' ' + DateUtil.startOf(new Date(), 'days').toLocaleTimeString(),
            'end-of-date': DateUtil.endOf(new Date(), 'days').toLocaleDateString() + ' ' + DateUtil.endOf(new Date(), 'days').toLocaleTimeString(),
            'start-of-week': DateUtil.startOf(new Date(), 'weeks').toLocaleDateString() + ' ' + DateUtil.startOf(new Date(), 'days').toLocaleTimeString(),
            'end-of-week': DateUtil.endOf(new Date(), 'weeks').toLocaleDateString() + ' ' + DateUtil.endOf(new Date(), 'days').toLocaleTimeString(),
            'start-of-month': DateUtil.startOf(new Date(), 'months').toLocaleDateString() + ' ' + + ' ' + DateUtil.startOf(new Date(), 'months').toLocaleTimeString(),
            'end-of-month': DateUtil.endOf(new Date(), 'months').toLocaleDateString() + ' ' + + ' ' + DateUtil.endOf(new Date(), 'months').toLocaleTimeString(),
            'add-days': DateUtil.add(new Date(), 1, 'days').toLocaleDateString() + ' ' + DateUtil.add(new Date(), 1, 'days').toLocaleTimeString(),
            'add-months': DateUtil.add(new Date(), 1, 'months').toLocaleDateString() + ' ' + DateUtil.add(new Date(), 1, 'months').toLocaleTimeString(),
            'subtract-days': DateUtil.subtract(new Date(), 1, 'days').toLocaleDateString() + ' ' + DateUtil.subtract(new Date(), 1, 'days').toLocaleTimeString(),
            'subtract-months': DateUtil.subtract(new Date(), 1, 'months').toLocaleDateString() + ' ' + DateUtil.subtract(new Date(), 1, 'months').toLocaleTimeString(),
        });
    }
}
